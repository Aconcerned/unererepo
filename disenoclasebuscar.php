...
$query="select * from reservadiseno where nombre = '$niet' OR materia='$niet'"; //Buscar materia o nombre
$result = mysqli_query($db, $query);
$res = '';

if (mysqli_num_rows($result) > 0) {
  while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
    $res = "Se encontro al profesor: <tr><td>"." ".$row['nombre']."."." "."El cual da la materia:"." ".$row['materia']."."." "."Su fecha de inscripcion en el sistema es:"." ".$row['fechainscripcion']."</td></tr>"."<br><br>";
	echo $res;
