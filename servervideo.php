...
<?php
	...
	//define reservacionvideoedit of column
	$columns = array(
		0 =>'nombre', 
		1 => 'materia',
		2 => 'fecha',
    ...
    if(isset($_POST['reservacionvideoedit']) && $_POST['reservacionvideoedit'] >= 0 &&  !$error) {
      $colcdt = $_POST['reservacionvideoedit'];
      $error = false;
    } else {
      $error = true;
    }
	...
	if(!$error) {
			$sql = "UPDATE reservatodo SET ".$columns[$colcdt]." = '".$colVal."' WHERE id='".$rowId."'";
